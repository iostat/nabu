...
public class ProtocolHelpers {
     ...
     * {@link ProtocolHelpers#readStringFromByteBuf(ByteBuf)}
    ...
    /**
     * Converts a series of bytes generated by {@link ProtocolHelpers#writeStringToByteBuf(String, ByteBuf)}
     * into a {@link String}
     * @param in a {@link ByteBuf} containing data to reconstuct into a String, ideally
     *           created by {@link ProtocolHelpers#writeStringToByteBuf(String, ByteBuf)} on the other end
